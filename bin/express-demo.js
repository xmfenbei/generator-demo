...
/**
 * Copy file from template directory.(TODO: xmfenbei)
 */

function copyTemplate (from, to) {
    from = path.join(__dirname, '..', 'templates/express', from)
...
function loadTemplate (name) {
    var contents = fs.readFileSync(path.join(__dirname, '..', 'templates/express', (name + '.ejs')), 'utf-8')
